...
class Game {
    ...
    init() {
        ...
        let currentBlockCoords = [betweenSpaceX, betweenSpaceY];
    ...
    movePlatform(mousePosX) {
        ...
        this.platform.x = mousePosX < leftLimitX ? 0 : ( mousePosX > rightLimitX ? (this.width - this.platform.width) : (mousePosX - leftLimitX) );
    }
